...
public class OtherDemo {
    public static void main(String[] args) {
        ...
        Class cls = OtherDemo.class;
        // 获取“类名”
        System.out.printf("%-60s:getSimpleName()=%s\n", cls, cls.getSimpleName());
        // 获取“完整类名”
        System.out.printf("%-60s:getName()=%s\n", cls, cls.getName());
    ...
    public static void testOtherAPIs() {
        ...
        System.out.printf("%-60s:isPrimitive()=%s\n",
                primCls, primCls.isPrimitive());

        // 类是不是“复合类”。 JVM中才会产生复合类，在java应用程序中不存在“复合类”！
        Class synCls = OtherDemo.class;
        System.out.printf("%-60s:isSynthetic()=%s\n",
