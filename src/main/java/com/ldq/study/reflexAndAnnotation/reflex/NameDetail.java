...
public class NameDetail {
    ...
    public void getClassName() {
        try {
            ...
            Class<?> cls1 = Class.forName("com.ldq.study.reflexAndAnnotation.entity.Person");
            //Class<Person> cls1 = Class.forName("com.ldq.study.reflexAndAnnotation.entity.Person");
            ...
            // 方法4："类名字符串".getClass()
            String str = "com.ldq.study.reflexAndAnnotation.entity.Person";
